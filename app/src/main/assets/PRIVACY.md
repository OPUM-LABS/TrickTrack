...
### 4. App Store Purchases & Payment Processing
TrickTrack is distributed as a paid application through the Google Play Store and as a free release via GitHub. For Play Store purchases, all transactions, payment processing, and billing details are handled exclusively and securely by **Google LLC**. Downloads via GitHub require no payment processing whatsoever. OPUM-Labs does not collect, receive, or store credit card numbers, banking details, or financial accounts under any circumstances.
...
The Application does not knowingly collect personal information from children under the age of 16. Since no personal data is transmitted off the Device, no child-identifying data is gathered or stored by Us.

---

### 7. Changes to This Privacy Policy

We may update Our Privacy Policy from time to time. Any changes will be posted within the Application or on Our official distribution page with an updated "Last updated" date.
